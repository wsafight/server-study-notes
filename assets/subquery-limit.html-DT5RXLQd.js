import{_ as n,c as e,b as a,o as i}from"./app-Wa3AeqG9.js";const l={};function d(c,s){return i(),e("div",null,s[0]||(s[0]=[a(`<h1 id="mysql-子查询中不能使用-limit" tabindex="-1"><a class="header-anchor" href="#mysql-子查询中不能使用-limit"><span>MYSQL 子查询中不能使用 LIMIT</span></a></h1><p>查询语句如下:</p><div class="language-SQL line-numbers-mode" data-highlighter="prismjs" data-ext="SQL" data-title="SQL"><pre><code><span class="line">select</span>
