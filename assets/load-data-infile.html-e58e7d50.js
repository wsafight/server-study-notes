import{_ as e,o as n,c as i,d as a}from"./app-6f934210.js";const d={},s=a(`<h1 id="插入导入数据优化" tabindex="-1"><a class="header-anchor" href="#插入导入数据优化" aria-hidden="true">#</a> 插入导入数据优化</h1><p>LOAD DATA 语句以非常高的速度将文本文件中的行读取到表中。该文件可以从服务器主机或客户端主机读取，具体取决于是否 LOCAL 给出修饰符。LOCAL 还影响数据解释和错误处理。</p><div class="language-SQL line-numbers-mode" data-ext="SQL"><pre class="language-SQL"><code>LOAD DATA
