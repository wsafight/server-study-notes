import{_ as n,c as e,b as i,o as l}from"./app-Wa3AeqG9.js";const a={};function r(p,s){return l(),e("div",null,s[0]||(s[0]=[i(`<h1 id="profiling-分析慢-sql-语句" tabindex="-1"><a class="header-anchor" href="#profiling-分析慢-sql-语句"><span>profiling 分析慢 sql 语句</span></a></h1><p>该方案适合开发调试阶段分析，因为它是针对处理进程(process)而不是线程(thread)的，服务器上的其他应用，可能会影响结果。</p><div class="language-SQL line-numbers-mode" data-highlighter="prismjs" data-ext="SQL" data-title="SQL"><pre><code><span class="line">-- 查看是否已经启用 profiling</span>
